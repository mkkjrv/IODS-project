...
Logistic regression model is a binary classification method. It can be used to identify factors related one of the two groups of alcohol consumption.
...
From the fitted model one see that all explanatory variables except age are statistically significant with p-value < 0,01. Variable absence is also statistically sisgnificant with p-value < 0,001. 
